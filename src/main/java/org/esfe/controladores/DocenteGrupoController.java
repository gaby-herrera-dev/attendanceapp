...
import org.esfe.servicios.imprementaciones.DocenteGrupoService;
...
public class DocenteGrupoController {
    ...
    @Autowired
    private DocenteGrupoService docenteGrupoService;

    @Autowired
    private IGrupoService grupoService;

    @Autowired
    private IDocenteService docenteervice;
    ...
    public String create(Model model) {
        model.addAttribute("docentes", docenteervice.obtenertodos());
    ...
    public String save(@RequestParam Integer docenteId, @RequestParam Integer grupoId,
        ...
        Docente docente = docenteervice.buscarPorId(docenteId).get();
        ...
        if (docente != null && grupo != null) {
            ...
            attributes.addFlashAttribute("msg", "Asignacion correctamente");
        }
    ...
    public  String delete(DocenteGrupo docenteGrupo, RedirectAttributes attributes){
        ...
        attributes.addFlashAttribute("msg", "Asignación elimninada");
        return "redirect:/asignaciones";
    }
}
